...
Groovy is the dynamic JVM and Gradle-history comparison. Kotlin is usually the stronger choice for new statically typed JVM or Android application code. Groovy remains useful where the code is a script, Spock test suite, Gradle Groovy DSL build, Jenkins-style pipeline, or dynamic DSL layer.
