...
Related memory concepts: [Manual Memory Management](/concepts/manual-memory-management/), [Stack Vs Heap Allocation](/concepts/stack-vs-heap-allocation/), [RAII And Deterministic Cleanup](/concepts/raii-and-deterministic-cleanup/), [Ownership](/concepts/ownership/), and [Memory Safety](/concepts/memory-safety/).
