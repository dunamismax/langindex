...
Related memory concepts: [Ownership](/concepts/ownership/), [RAII And Deterministic Cleanup](/concepts/raii-and-deterministic-cleanup/), [Stack Vs Heap Allocation](/concepts/stack-vs-heap-allocation/), [Reference Counting](/concepts/reference-counting/), and [Memory Safety](/concepts/memory-safety/).
...
Related concurrency concepts: [Threads And Shared Memory](/concepts/threads-and-shared-memory/), [Async Await And Event Loops](/concepts/async-await-and-event-loops/), [Data Races And Memory Models](/concepts/data-races-and-memory-models/), and [Structured Concurrency](/concepts/structured-concurrency/).
...
Related tooling concepts: [Package Managers](/concepts/package-managers/), [Build Systems](/concepts/build-systems/), [Compilation Targets](/concepts/compilation-targets/), [Formatters And Linters](/concepts/formatters-and-linters/), [Language Servers And Editor Tooling](/concepts/language-servers-and-editor-tooling/), and [Documentation Cultures](/concepts/documentation-cultures/).
