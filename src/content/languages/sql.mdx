...
Transact-SQL is the nearby Microsoft SQL Server and Azure SQL dialect when stored procedures, functions, triggers, temporary tables, SQL Server permissions, and execution plans become first-class architecture. Use it deliberately rather than assuming SQL Server-specific code is portable SQL.
