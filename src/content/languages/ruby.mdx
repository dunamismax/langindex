...
JavaScript and TypeScript matter when browser alignment, npm, frontend frameworks, or full-stack JavaScript are the dominant constraints. Crystal is nearby for Ruby-like syntax with static typing and native compilation.
