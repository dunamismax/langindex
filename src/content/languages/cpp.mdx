...
Related memory concepts: [RAII And Deterministic Cleanup](/concepts/raii-and-deterministic-cleanup/), [Reference Counting](/concepts/reference-counting/), [Manual Memory Management](/concepts/manual-memory-management/), [Ownership](/concepts/ownership/), and [Memory Safety](/concepts/memory-safety/).
