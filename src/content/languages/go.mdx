...
Related concepts: [Static vs Dynamic Typing](/concepts/static-vs-dynamic-typing), [Structural vs Nominal Typing](/concepts/structural-vs-nominal-typing), [Generics and Parametric Polymorphism](/concepts/generics-and-parametric-polymorphism), and [Null Safety](/concepts/null-safety).
...
Related concurrency concepts: [Goroutines And Green Threads](/concepts/goroutines-and-green-threads/), [Threads And Shared Memory](/concepts/threads-and-shared-memory/), [Actor Model And Message Passing](/concepts/actor-model-and-message-passing/), and [Data Races And Memory Models](/concepts/data-races-and-memory-models/).
...
Related tooling concepts: [Modules And Namespacing](/concepts/modules-and-namespacing/), [Package Managers](/concepts/package-managers/), [Build Systems](/concepts/build-systems/), [Formatters And Linters](/concepts/formatters-and-linters/), and [Testing Cultures](/concepts/testing-cultures/).
...
Related runtime concepts: [Interpreters, JIT, And AOT](/concepts/interpreters-jit-and-aot/), [Compilation Targets](/concepts/compilation-targets/), and [Standard Library Philosophy](/concepts/standard-library-philosophy/).
