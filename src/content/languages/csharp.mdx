...
officialSite: https://learn.microsoft.com/en-us/dotnet/csharp/
...
Related concepts: [Static vs Dynamic Typing](/concepts/static-vs-dynamic-typing), [Structural vs Nominal Typing](/concepts/structural-vs-nominal-typing), [Generics and Parametric Polymorphism](/concepts/generics-and-parametric-polymorphism), [Algebraic Data Types and Pattern Matching](/concepts/algebraic-data-types-and-pattern-matching), and [Null Safety](/concepts/null-safety).
...
Related memory concepts: [Garbage Collection](/concepts/garbage-collection/), [Stack Vs Heap Allocation](/concepts/stack-vs-heap-allocation/), [RAII And Deterministic Cleanup](/concepts/raii-and-deterministic-cleanup/), and [Memory Safety](/concepts/memory-safety/).
...
Related concurrency concepts: [Async Await And Event Loops](/concepts/async-await-and-event-loops/), [Threads And Shared Memory](/concepts/threads-and-shared-memory/), [Data Races And Memory Models](/concepts/data-races-and-memory-models/), and [Structured Concurrency](/concepts/structured-concurrency/).
...
var targets = new[]
{
    new Endpoint("C#", new Uri("https://learn.microsoft.com/en-us/dotnet/csharp/")),
...
F# is the functional .NET comparison. F# is worth evaluating when a .NET system needs records, discriminated unions, pattern matching, pipelines, type inference, and functional-first domain modeling more than it needs the broadest C# examples and staffing pool. See [F# vs C#](/comparisons/fsharp-vs-csharp) for the focused comparison.
...
Delphi is a desktop and business-application comparison when an organization already owns Object Pascal, RAD Studio, VCL, or FireMonkey code. C# is usually the stronger default for new .NET-centered services, tools, and client applications; Delphi often remains the lower-risk maintenance choice for stable VCL applications and component-heavy Windows systems.
