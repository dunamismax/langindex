...
Prefer shell when the job is mostly a short pipeline around existing Unix commands. Prefer Go or Rust when the tool needs static binary distribution, faster startup under heavy repeated invocation, or stronger compile-time guarantees.
