...
Many games use more than one language. A common split is C++ for engine and performance-critical systems, C# for Unity gameplay and tools, visual scripting for designer-authored behavior, Lua for embedded scripting, modding, or data-driven logic, and JavaScript or TypeScript for web games or tooling.
