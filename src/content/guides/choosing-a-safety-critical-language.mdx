...
summary: A practical guide for choosing Ada, SPARK, C, C++, Rust, or another language for safety-critical and high-integrity software by certification context, target runtime, tool qualification, analyzability, and team evidence.
audience: Teams choosing implementation languages for software where defects can create safety, security, regulatory, or mission consequences.
candidates:
  - ada
  - rust
  - c
