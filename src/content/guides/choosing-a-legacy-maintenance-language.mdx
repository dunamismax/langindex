...
summary: A decision guide for maintaining, modernizing, wrapping, or replacing older production systems in Perl, PHP, CFML, Ruby, shell, C, C++, Java, Python, Objective-C, Fortran, COBOL, Delphi, Visual Basic, VBA, ABAP, PL/SQL, Transact-SQL, SAS, and related languages.
