...
summary: A decision guide for maintaining, modernizing, wrapping, or replacing older production systems in Perl, PHP, Ruby, shell, C, C++, Java, Python, Objective-C, Fortran, and related languages.
...
The first question is not "what would we write today?" The first question is "what must keep working while we learn enough to change it safely?" A stable Perl, PHP, Ruby, shell, C, C++, Java, Objective-C, or Fortran system can be worth maintaining when the business behavior is known and the runtime can still be supported. A rewrite is justified only when it reduces a concrete risk that modernization in place cannot address.
...
Objective-C and Fortran systems usually exist because they sit near platform APIs, numerical code, or long-lived domain libraries. Preserve tested boundaries before moving behavior to Swift, C++, Python, Julia, Rust, or another platform.
