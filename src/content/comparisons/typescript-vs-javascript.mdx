...
Related concepts: [Static vs Dynamic Typing](/concepts/static-vs-dynamic-typing), [Structural vs Nominal Typing](/concepts/structural-vs-nominal-typing), [Type Inference](/concepts/type-inference), and [Null Safety](/concepts/null-safety).
