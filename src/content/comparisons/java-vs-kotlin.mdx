...
Related concepts: [Null Safety](/concepts/null-safety), [Generics and Parametric Polymorphism](/concepts/generics-and-parametric-polymorphism), [Static vs Dynamic Typing](/concepts/static-vs-dynamic-typing), [Async Await And Event Loops](/concepts/async-await-and-event-loops/), [Structured Concurrency](/concepts/structured-concurrency/), and [Virtual Machines And Bytecode](/concepts/virtual-machines-and-bytecode/).
