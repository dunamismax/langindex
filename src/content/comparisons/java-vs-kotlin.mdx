...
Related concepts: [Null Safety](/concepts/null-safety), [Generics and Parametric Polymorphism](/concepts/generics-and-parametric-polymorphism), and [Static vs Dynamic Typing](/concepts/static-vs-dynamic-typing).
