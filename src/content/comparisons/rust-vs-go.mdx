...
Related concepts: [Ownership](/concepts/ownership), [Static vs Dynamic Typing](/concepts/static-vs-dynamic-typing), [Structural vs Nominal Typing](/concepts/structural-vs-nominal-typing), [Generics and Parametric Polymorphism](/concepts/generics-and-parametric-polymorphism), [Algebraic Data Types and Pattern Matching](/concepts/algebraic-data-types-and-pattern-matching), [Null Safety](/concepts/null-safety), [Goroutines And Green Threads](/concepts/goroutines-and-green-threads/), [Data Races And Memory Models](/concepts/data-races-and-memory-models/), and [Foreign Function Interface](/concepts/foreign-function-interface/).
