...
summary: Elixir and Erlang share the BEAM and OTP foundation, but Elixir emphasizes modern syntax, Mix, Hex, macros, and Phoenix while Erlang remains the original OTP language with direct OTP conventions, telecom roots, and mature infrastructure libraries.
languages:
  - elixir
  - erlang
useCases:
