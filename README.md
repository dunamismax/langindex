...
- `languages` — 48 individual programming language profiles.
- `comparisons` — 74 dimensional, tradeoff-first comparisons between related
  languages.
- `guides` — 23 cross-language decision guides framed by the problem the
