...
- `languages` — 41 individual programming language profiles.
- `comparisons` — 58 dimensional, tradeoff-first comparisons between related
  languages.
- `guides` — 22 cross-language decision guides framed by the problem the
